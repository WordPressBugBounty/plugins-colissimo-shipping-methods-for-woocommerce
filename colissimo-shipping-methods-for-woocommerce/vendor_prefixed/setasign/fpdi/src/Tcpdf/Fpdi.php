...
namespace Colissimo\Vendor\setasign\Fpdi\Tcpdf;

use Colissimo\Vendor\setasign\Fpdi\FpdiException;
use Colissimo\Vendor\setasign\Fpdi\FpdiTrait;
use Colissimo\Vendor\setasign\Fpdi\PdfParser\CrossReference\CrossReferenceException;
use Colissimo\Vendor\setasign\Fpdi\PdfParser\Filter\AsciiHex;
 ...
 */
class Fpdi extends \ColissimoTCPDF
{
    use FpdiTrait {
