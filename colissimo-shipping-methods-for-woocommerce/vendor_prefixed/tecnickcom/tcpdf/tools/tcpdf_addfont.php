...
// -------------------------------------------------------------------
//
// Description : This is a command line script to generate ColissimoTCPDF fonts.
//
//============================================================+

/**
 * @file
 * This is a command line script to generate ColissimoTCPDF fonts.<br>
...
function showHelp() {
	$help = <<<EOD
tcpdf_addfont - command line tool to convert fonts for the ColissimoTCPDF library.
...
echo "\n>>> Converting fonts for ColissimoTCPDF:\n";
...
foreach ($options['fonts'] as $font) {
	...
	$fontname = ColissimoTCPDF_FONTS::addTTFfont($fontfile, $options['type'], $options['enc'], $options['flags'], $options['outpath'], $options['platid'], $options['encid'], $options['addcbbox'], $options['link']);
	if ($fontname === false) {
		$errors = true;
