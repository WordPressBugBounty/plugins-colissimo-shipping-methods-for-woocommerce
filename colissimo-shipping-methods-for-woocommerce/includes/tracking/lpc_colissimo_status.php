...
class LpcColissimoStatus extends LpcComponent {
    ...
    protected $status_list = array(
        ...
        185 => ['clp' => 'QDICFM', 'is_anomaly' => false, 'change_order_status' => null, 'label' => 'Votre colis sera présenté le prochain jour ouvré et nécessite une remise en mains propres. Si vous êtes absent, vous pouvez nous donner vos instructions sur www.colissimo.fr/monchoix.'],
        ...
        228 => ['clp' => 'RENARV', 'is_anomaly' => false, 'change_order_status' => null, 'label' => 'Votre colis n\'a pu être livré car le destinataire était absent. Il sera remis en livraison le prochain jour ouvré. Le destinataire peut se rendre sur https://www.colissimo.fr/monchoix pour donner de nouvelles instructions.'],
