...
class BlocksIntegration implements IntegrationInterface {
    ...
    public function registerMainIntegration() {
        $script_path = '/assets/js/blockCheckout/index.js';

        $script_asset_path = LPC_FOLDER . 'assets' . DS . 'js' . DS . 'blockCheckout' . DS . 'index.asset.php';
        ...
        wp_register_script(
            ...
            plugins_url($script_path, LPC_MAIN_FILE),
