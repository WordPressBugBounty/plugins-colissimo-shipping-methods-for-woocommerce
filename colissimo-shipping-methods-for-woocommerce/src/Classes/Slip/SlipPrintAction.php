...
class SlipPrintAction {
    ...
    public function control() {
        ...
        try {
            ...
            $deliverySlipFileName = $tempDir . 'bordereau(' . $deliverySlipId . ').pdf';

            Helper::getWpFilesystem()->put_contents($deliverySlipFileName, $deliverySlip, FS_CHMOD_FILE);

            MergePdf::merge([$deliverySlipFileName], MergePdf::DESTINATION__INLINE);

            wp_delete_file($deliverySlipFileName);
